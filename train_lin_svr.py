...
for train_index, test_index in kf.split(X):
    ...
    plt.scatter(train_index, svr_lin.predict(train_x),facecolor="none",edgecolor="k", label="SF in train dataset")
    plt.scatter(test_index, svr_lin.predict(test_x),facecolor="orange", label="SF in test dataset")
